...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-card border border-line p-6">
      ...
      {state === "success" && <p className="mt-4 rounded-card bg-plum-50 p-3 text-[13.5px] text-ink/80">This frontend is ready for backend routing. No production message was sent yet.</p>}
