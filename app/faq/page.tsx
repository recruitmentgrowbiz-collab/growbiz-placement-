...
export const metadata = {
  title: "Frequently Asked Questions | Grow Biz",
  description: "Answers for candidates, employers, recruitment services, verification and safety at Grow Biz.",
};
    ...
    <>
      <section className="border-b border-line bg-plum-50/60">
        <Container className="py-16 md:py-20">
          <Kicker>FAQ</Kicker>
          <h1 className="mt-4 text-balance font-display text-[34px] font-bold leading-[1.12] text-ink md:text-[44px]">Frequently Asked Questions</h1>
          <p className="mt-4 max-w-xl text-[16.5px] leading-relaxed text-mist">Answers for candidates and employers about applications, verification, recruitment support and safety.</p>
        </Container>
      </section>
      <section className="py-16 md:py-20">
        <Container className="space-y-10">
          {groups.map((group) => (
            <section key={group.title} aria-labelledby={`${group.title}-faq`}>
              <h2 id={`${group.title}-faq`} className="font-display text-[22px] font-bold text-ink">{group.title}</h2>
          ...
          <section aria-labelledby="trust-safety-faq">
            ...
            <div className="mt-4 divide-y divide-line border-t border-line">
              ...
              <details className="py-5"><summary className="cursor-pointer font-medium text-ink">How do I report a suspicious job?</summary><p className="mt-2 text-[14.5px] leading-relaxed text-mist">Use the Report / Safety page or the report option on a job listing when something looks suspicious or misleading.</p></details>
            </div>
          </section>
        </Container>
      </section>
