  ...
  return (
    <div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {quickActions.map(({ label, href, icon: Icon }) => <Link key={href} href={href} className="flex min-h-16 items-center gap-3 rounded-card border border-line bg-white p-4 text-[14px] font-medium text-ink hover:border-plum-300"><Icon size={18} className="text-plum-600" />{label}</Link>)}
      </div>
