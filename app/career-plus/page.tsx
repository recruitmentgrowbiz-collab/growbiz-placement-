...
export const metadata = {
  title: "Career Plus | Grow Biz Jobs",
  description: "Optional career support for resume improvement, interview readiness and career preparation.",
};
    ...
    <>
      <section className="border-b border-line bg-plum-50/60">
        <Container className="py-16 md:py-20">
          ...
          <h1 className="mt-4 text-balance font-display text-[34px] font-bold leading-[1.12] text-ink md:text-[44px]">Career Support Beyond Job Search</h1>
          <p className="mt-4 max-w-2xl text-[16.5px] leading-relaxed text-mist">Optional tools and support to help candidates improve their resume, interview readiness and career preparation.</p>
          <div className="mt-7"><PrimaryButton href="/contact">Learn More</PrimaryButton></div>
        </Container>
      </section>
      <section className="border-b border-line py-16 md:py-20">
        <Container className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <p className="mt-3 text-[15px] leading-relaxed text-mist">Career Plus is separate from job applications and employer hiring workflows. Pricing is coming soon.</p>
          </div>
      ...
      <section className="py-16 md:py-20">
        <Container className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr]">
          ...
          <div className="divide-y divide-line border-t border-line">
            ...
            <details className="py-5"><summary className="cursor-pointer font-medium text-ink">What is the price?</summary><p className="mt-2 text-[14.5px] text-mist">Pricing is coming soon and remains configurable.</p></details>
          </div>
